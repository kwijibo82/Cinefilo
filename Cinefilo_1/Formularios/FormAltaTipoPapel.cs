...
{
    public partial class FormAltaTipoPapel : Form
    {
        public FormAltaTipoPapel()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                BDCinefilo.altaTipoPapel(textBoxTipoPapel.Text);
                textBoxTipoPapel.Text = "";
        ...
        private void FormAltaTipoPapel_Load(object sender, EventArgs e)
        {
